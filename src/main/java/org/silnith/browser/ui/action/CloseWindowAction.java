    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        if (numberOfTabs < 2) {
            ...
            final String message =
                    String.format("The window currently has %d tabs open.  Close all tabs?", numberOfTabs);
                    
            final int choice = JOptionPane.showConfirmDialog(browserWindow, message, "Close Window?",
